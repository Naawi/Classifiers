...
y = iris.target # what's the target? most likely the answers to each row in the data. i.e. the type of iris

# Now create a decision tree and fit it to the iris data:
iris_tree = tree.DecisionTreeClassifier(criterion="entropy").fit(X, y) #x is the features and y is the correct answer
